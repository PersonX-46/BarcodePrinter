...
class BarcodeApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.item_table.setStyleSheet("""
            QTableWidget {
                background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(47, 141, 255, 255), stop:1 rgba(22, 79, 149, 255));
                border: 2px solid rgb(53, 132, 228);
                border-radius: 12px;
                font-size: 16px;
                padding: 4px;
            ...
            QTableWidget::item {
                background: rgba(255, 255, 255, 130);  /* Light translucent */
                border: none;
            }
            QHeaderView::section {
                background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 rgba(53, 132, 228, 255), stop:1 rgba(26, 95, 180, 255));
                color: white;
                font-size: 16px;
                font-weight: bold;
    ...
    def loadStylesheet(self):
        try:
            ...
            stylesheet = """
            QMainWindow { background: qradialgradient(spread:reflect, cx:0.5, cy:0.5, radius:0.5, fx:0.5, fy:0.4995, stop:0 rgba(0, 0, 106, 255), stop:1 rgba(0, 12, 27, 255));}
